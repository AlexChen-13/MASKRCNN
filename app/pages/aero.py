...
@st.cache_resource
def load_unet_model(model_path="/home/aleksey/DS_bootcamp/MASKRCNN/models/unet_model.pth"):
...
image_path1 = "/home/aleksey/DS_bootcamp/MASKRCNN/Images/aero_images/metrics.jpg"  # Замените на путь к вашему изображению
image_path2 = "/home/aleksey/DS_bootcamp/MASKRCNN/Images/aero_images/metrics_2.jpg"  # Замените на путь к вашему изображению
image_path3 = "/home/aleksey/DS_bootcamp/MASKRCNN/Images/aero_images/confusion_matrix.jpg"  # Замените на путь к вашему изображению

# Загрузка и отображение первого изображения
img1 = Image.open(image_path1).convert("RGB")
st.image(img1, caption="/home/aleksey/DS_bootcamp/MASKRCNN/Images/aero_images/metrics.jpg" , use_column_width=True)

# Загрузка и отображение второго изображения
img2 = Image.open(image_path2).convert("RGB")
st.image(img2, caption="/home/aleksey/DS_bootcamp/MASKRCNN/Images/aero_images/metrics_2.jpg", use_column_width=True)

# Загрузка и отображение третьего изображения
img3 = Image.open(image_path3).convert("RGB")
st.image(img3, caption="/home/aleksey/DS_bootcamp/MASKRCNN/Images/aero_images/confusion_matrix.jpg", use_column_width=True)
